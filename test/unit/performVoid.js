...
describe('perform auth void', function() {
    before(function() {
        request = new Request();
    ...
    it ('should perform a void of an auth', function (done) {
        service.performAuthOnly(request, {}, function(results, request, response) {
            //perform auth and then void it
            service.performVoid(request, {}, function (responseCode, request, response) {
