...
describe('perform credit', function() {
    before(function() {
        request = new Request();
    ...
    it ('should perform a purchase and a credit', function (done) {
        service.performPurchase(request, {}, function(results, request, response) {
            requestCredit = {};
            requestCredit.merchantID = 1;
            requestCredit.merchantPassword = 'testpassword';
            requestCredit.referenceGUID = request.referenceGUID;

            service.performCredit(requestCredit, {}, function (responseCode, request, response) {
